import { defineComponent, type PropType, unref, computed } from 'vue'
import { createFromIconfontCN } from '@ant-design/icons-vue'
import { isString } from '@/utils/is'

// let scriptUrls = [`${import.meta.env.BASE_URL}iconfont.js`]
let scriptUrls = ['//at.alicdn.com/t/font_3446023_w083f8b667h.js']

let MyIconFont = createFromIconfontCN({
  // scriptUrl: '//at.alicdn.com/t/font_3446023_w083f8b667h.js',
